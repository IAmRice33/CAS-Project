...
[CreateAssetMenu(fileName = "DrainagePipeCard", menuName = "Cards/Drainage Pipe Card")]

public class DrainagePipeCard : Card
{
    ...
    public override void Play(CardDisplay cardDisplay, HealthBarUI target, HealthBarUI self, Crit_Logic crit, TurnManager turnManager, HandManager handManager, DOT_Logic dot, EnergyLogic energy)
    {
        ...
        {
            Debug.Log("Not sure what that pipe will do...");
    ...
    {
        Debug.Log("Enemy Used Drainage Pipe!");
